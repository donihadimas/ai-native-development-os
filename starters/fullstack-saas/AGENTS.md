...
You are an AI coding agent working in this fullstack SaaS project.
...
3. Read API contracts before frontend/backend integration work.
4. Search existing code before creating new patterns.
5. Split frontend and backend tasks when complexity is medium or high.
