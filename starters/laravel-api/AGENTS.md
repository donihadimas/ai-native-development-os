...
You are an AI coding agent working in this Laravel API project.
...
In lite mode, use `AGENTS.md`, `.aios/repo-map.json`, active project docs, and any root-level AIOS skills/templates/references/workflows available to the agent. Do not assume `.aios/` exists.
...
4. Use `.aios/repo-map.json` to choose the smallest relevant context set.
...
6. Read API contracts before endpoint work.
