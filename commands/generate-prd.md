...
Before creating the final PRD, apply the skill's Clarification Gate. If product intent, scope, target users, success metrics, or constraints are vague, ask focused questions first.
