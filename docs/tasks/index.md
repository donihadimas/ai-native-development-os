...
Completed task bodies live under `docs/tasks/done/`. Read a completed task only for release planning, audit, completed-task review, or explicit continuation.
...
- Do not search `docs/tasks/done/` unless completed history is explicitly needed.
