...
export default defineConfig({
  site: 'https://donihadimas.github.io',
  base: '/ai-native-development-os',
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Skills Folder', link: '/reference/skills-folder' },
            { label: 'Templates Folder', link: '/reference/templates-folder' },
