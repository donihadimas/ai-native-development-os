...
1. Resolve the active task without reading every task body when a feature PRD or task file is not explicit. Use `docs/tasks/index.md` when available, then direct task filenames under `docs/tasks/`, and focus on active tasks before completed tasks.
